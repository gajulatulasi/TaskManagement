...
const Login = () => {
  ...
  return (
    ...
    >
      ...
      {/* Accent Gradients */}
      <div className="absolute top-[-10%] left-[-10%] w-96 h-96 bg-indigo-500/10 blur-[120px] rounded-full pointer-events-none z-0"></div>
      <div className="absolute bottom-[-10%] right-[-10%] w-96 h-96 bg-purple-500/10 blur-[120px] rounded-full pointer-events-none z-0"></div>
